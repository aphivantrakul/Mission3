...
;
var answers;
electron_1.ipcMain.on("questionClicked", function (event, questionNum) {
    return __awaiter(this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(answerWindow === null || answerWindow === undefined)) return [3 /*break*/, 5];
                ...
                case 2:
                    answers = _a.sent();
                    return [4 /*yield*/, answerWindow.loadFile("answer.html")];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
...
function getQuestions() {
    return new Promise(function (resolve, reject) {
        var request = electron_1.net.request("http://localhost:3000/questions");
...
function getAnswers() {
    return new Promise(function (resolve, reject) {
        var request = electron_1.net.request("http://localhost:3000/answers");
        request.on("response", function (response) {
            response.on("data", function (data) {
                resolve(JSON.parse(data.toString()));
            });
